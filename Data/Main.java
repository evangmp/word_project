...
public class Main {
    ...
    public void second_main() {
        while (true) { // while loop to choose list to learn or to modify
    ...
    public void list_choice(){ // print all the lists available with an input for choose
...
class Learn_Menu extends Main {
    public void main_menu(String list) { // with the list name, possibility to delete or add a word, and learn
        Scanner scanner = new Scanner(System.in);
