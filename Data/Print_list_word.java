...
public class Print_list_word { // rename + possible to reuse, to have a dictionary of all the word from a list
    // like put an integer and switch
...
class Just_word extends Print_list_word {
    Just_word() {
        super();
    }

    public Map<Integer, String> word_sel(String list_choice, String which_word) { // intermediate with DB
    ...
    public Map<Integer, Integer> int_sel(String list_choice, String which_word) {
